...
public interface ExtendedLightEngine<M> {
    /**
     ...
     * {@link ExtendedLightEngine#getBlockStateForLighting(int, int, int)}.
     */
     ...
     * {@link ExtendedLightEngine#getBlockStateForLighting(int, int, int)} to retrieve the block state
